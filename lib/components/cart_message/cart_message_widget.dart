...
import 'cart_message_model.dart';
export 'cart_message_model.dart';

class CartMessageWidget extends StatefulWidget {
  const CartMessageWidget({super.key});
...
class _CartMessageWidgetState extends State<CartMessageWidget>
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CartMessageModel());
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: ClipRRect(
                                  ...
                                  child: Image.asset(
                                    'assets/images/hook-1727484_1920.png',
                                    width: 300.0,
                                    height: 200.0,
                                    fit: BoxFit.cover,
                                  ),
