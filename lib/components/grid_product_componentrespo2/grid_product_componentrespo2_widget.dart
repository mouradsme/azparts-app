...
import 'grid_product_componentrespo2_model.dart';
export 'grid_product_componentrespo2_model.dart';

class GridProductComponentrespo2Widget extends StatefulWidget {
  const GridProductComponentrespo2Widget({
    super.key,
    this.productImage,
  ...
  @override
  State<GridProductComponentrespo2Widget> createState() =>
      _GridProductComponentrespo2WidgetState();
}

class _GridProductComponentrespo2WidgetState
    extends State<GridProductComponentrespo2Widget> {
  late GridProductComponentrespo2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GridProductComponentrespo2Model());
