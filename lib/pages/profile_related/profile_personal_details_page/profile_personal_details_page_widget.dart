...
import 'profile_personal_details_page_model.dart';
export 'profile_personal_details_page_model.dart';

class ProfilePersonalDetailsPageWidget extends StatefulWidget {
  const ProfilePersonalDetailsPageWidget({super.key});

  @override
  State<ProfilePersonalDetailsPageWidget> createState() =>
      _ProfilePersonalDetailsPageWidgetState();
}

class _ProfilePersonalDetailsPageWidgetState
    extends State<ProfilePersonalDetailsPageWidget> {
  late ProfilePersonalDetailsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProfilePersonalDetailsPageModel());
            ...
            SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(0.0, 35.0, 0.0, 10.0),
                    child: wrapWithModel(
                      model: _model.appBarProfilDetailsModel,
                      updateCallback: () => setState(() {}),
                      child: const AppBarProfilDetailsWidget(),
                    ),
                  ),
                  Padding(
                    padding:
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    setState(() {
                                      ...
                                      FFAppState().image = FFAppState().image;
                                    });
                                    setState(() {
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          title:
                                              const Text('Modifications Effectuées'),
                                          content: const Text(
